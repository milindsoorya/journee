            ...
            {isCollapsed ? (
                ...
                <div className="flex flex-col flex-grow w-full overflow-y-auto">
                    ...
                    <details className="mb-4" open>
                        <summary className="font-semibold text-sm cursor-pointer p-2 border-b border-background/20 hover:text-primary list-none text-sidebar-foreground">✅ Checklist (3/5)</summary>
                        <p className="mt-2 text-sm space-x-2">
                            <a href="#" className="text-primary hover:underline">Apple Notes</a> | 
                            <a href="#" className="text-primary hover:underline">Notion</a>
                        </p>
                    </details>
